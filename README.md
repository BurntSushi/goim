...
IMDb will be discontinuing their ancient FTP service and will instead switch
to a TSV format that is hosted on Amazon S3. See their announcement for more
details:
